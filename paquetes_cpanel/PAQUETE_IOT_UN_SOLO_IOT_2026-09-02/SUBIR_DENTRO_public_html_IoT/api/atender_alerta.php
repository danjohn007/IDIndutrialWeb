...
if ($textLength($responsable) < 2 || $textLength($responsable) > 100) {
    responderJson(422, ['ok' => false, 'error' => 'Indica un responsable valido']);
}
...
try {
    ...
    error_log('ID Industrial alertas: ' . $error->getMessage());
