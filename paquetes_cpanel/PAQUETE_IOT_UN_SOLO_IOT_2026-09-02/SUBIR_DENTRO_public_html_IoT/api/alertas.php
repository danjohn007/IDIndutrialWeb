...
$porPagina = filter_var($_GET['por_pagina'] ?? 25, FILTER_VALIDATE_INT);
$pagina = $pagina === false ? 1 : max(1, $pagina);
$porPagina = $porPagina === false ? 25 : max(10, min(100, $porPagina));
...
$stmtDispositivos->execute(['cliente_id' => (int) $usuario['cliente_id']]);
