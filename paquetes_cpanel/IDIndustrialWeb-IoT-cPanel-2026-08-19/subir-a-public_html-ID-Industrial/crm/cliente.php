    ...
    <aside class="crm-client-sidebar" id="cliente-sidebar">
      ...
      <nav class="crm-client-nav" aria-label="Navegación del portal cliente">
        <?php foreach (['Panel' => ['resumen', 'proyectos'], 'Mantenimiento' => ['bitacora', 'solicitudes', 'cotizaciones'], 'Cuenta' => ['notificaciones', 'perfil']] as $groupLabel => $groupViews): ?>
          ...
          <?php endforeach; ?>
        <?php endforeach; ?>
        <p class="crm-client-nav__label">Sistemas</p>
        <a href="<?php echo h(crm_portal_url('iot', $activeOpportunityId)); ?>">
          <span><?php echo bitacora_icon('iot'); ?></span>Monitoreo IoT
        </a>
        <a href="<?php echo h(crm_public_url()); ?>">
          <span><?php echo bitacora_icon('open'); ?></span>Vista publica
        </a>
      </nav>
